...
def main() -> int:
    ...
    if not instruction_files:
        instruction_findings.append(
            "no project agent instruction files (informational until collaboration, risk, or repeated failures show a need)"
        )
    ...
    instruction_status = "INFO" if not instruction_files else ("WARN" if instruction_findings else "PASS")
