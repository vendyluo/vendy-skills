...
# standalone and run inside an arbitrary target project, so they import only
# stdlib. Do not hoist them into a shared scripts/ module: that would couple
# each standalone tool to this repository's install layout.
